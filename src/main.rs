...
fn solve_b(board_size:usize){
    ...
    while i<100{
        ...
        let res = linear_programming_solvers::find_known_squares(&board, linear_programming_solvers::create_constraint_set_b);
...
fn solve_n(board_size:usize){
    ...
    while i<100{
        ...
        let board = construct_board::get_board(board_size, construct_board::VisionType::ChessSmall);

        println!("{}", board);

        let res = linear_programming_solvers::find_known_squares(&board, linear_programming_solvers::create_constraint_set_n);
